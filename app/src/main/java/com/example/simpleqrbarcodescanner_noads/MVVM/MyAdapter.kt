...
*/
            ...
            Barcode.TYPE_CONTACT_INFO ->{
                try {
                    ...
                    arraylisttt?.let { bundle?.putStringArrayList(Intent_KEYS.CONTACTS_ARRAYLIST, it) }
                }catch (e:Exception){}
            }
            //doesnot suppported
            Barcode.TYPE_DRIVER_LICENSE ->{
...
/**GEEKS FOR GEEKS APPROACH METHOD*/
   /* fun clickItem(holder: MyViewHolder)
    {
        var item:EntityClass = arrayList.get(holder.adapterPosition)
