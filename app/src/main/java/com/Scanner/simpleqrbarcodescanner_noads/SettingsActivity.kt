...
import com.Scanner.simpleqrbarcodescanner_noads.databinding.ActivitySettingsBinding
        ...
        override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
            ...
            PrivacyPreference?.setOnPreferenceClickListener {
               val intent =Intent(Intent.ACTION_VIEW)
                intent.data = Uri.parse("https://pages.flycricket.io/qr-code-barcode-sc-9/privacy.html")
